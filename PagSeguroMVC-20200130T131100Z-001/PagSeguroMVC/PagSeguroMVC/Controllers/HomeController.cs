...
namespace PagSeguroMVC.Controllers
{
    /// <summary>
    /// Controller de testes pagseguro.
    /// </summary>
    public class HomeController : Controller
    {
        ...
        /// Post Checkout.
        /// </summary>
        /// <returns>Json com dados do checkout.</returns>
        [HttpPost]
        public JsonResult Checkout()
        {
            ...
            postData.Add("email", "seuemail@gmail.com");
            postData.Add("token", "37172471234567891E237A43DF293B0E");
        ...
        public JsonResult ConsultaTransacao()
        {
            ...
            string uri = "https://ws.pagseguro.uol.com.br/v3/transactions/F58B09AD125487A6A3DF7C2092D70D4B?email=seuemail@gmail.com&token=5BCC19FCF5624343AD3A25DAF3D8E74C";
